...
app.get('/terms', (req, res) => {
    res.send("<h1>Terms of Service</h1><p>This tool is for informational purposes only. Information is fetched from official available API sources.</p><br><a href='/'>Back to Home</a>");
});
